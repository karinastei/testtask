...
{
    public static function createProduct($type, $SKU, $name, $price, $amount, $type)
    {
...
try {
    ...
    while ($row = $productData->fetch_assoc()) {
        ...
        $product = ProductFactory::createProduct($productType, $productSKU, $productName, $productPrice);
